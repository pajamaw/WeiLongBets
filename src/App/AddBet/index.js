...
export default AddBet extends Component {
  constructor(props){
  ...
  render () {
    return (
      ...
      <div id="container">
        ...
        <form onSubmit={this.props.handleSubmit} method="post" id="bet_form">
        <div class="title">
          <label for="title"></label>
          <input name="title" value={this.state.title} onChange={this.handleChange} placeholder="Brief title" id="title_input" cols="30" rows="1" required></input>
        </div>
          <div class="description">
            <label for="description"></label>
            <textarea name="description" value={this.state.description} onChange={this.handleChange} placeholder="Bet Description - Try and detail it well!" id="description_input" cols="30" rows="5" required></textarea>
          </div>
          <div class="category">
            <label for="category"></label>
            <select placeholder="Category" name="category" id="category_input" value={this.state.category} onChange={this.handleChange} required>
          ...
          <div class="wager">
            ...
            <input type="number" placeholder="Your wager" name="wager" value={this.state.wager} onChange={this.handleChange} id="wager_input" required/>
          </div>
          <div class="duration">
            <label for="duration"></label>
            <input type="duration" placeholder="Duration" name="duration" value={this.state.duration} onChange={this.handleChange} id="duration_input" required/>
          </div>
          <div class="submit">
